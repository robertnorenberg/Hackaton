...
public class UnityDefaultGui_OculusRift : MonoBehaviour 
{
	public const float HEIGHT = 150;
	public const float WIDTH = 200;

	public const float HEIGHT_RATIO = 0.2f;
	public const float WIDTH_RATIO = 0.3f;
	...
	private void DrawGUI(float horizontalOffset = 0f)
	{
		Rect dialogueBoxRect = new Rect( Screen.width*(0.1f + horizontalOffset), Screen.height * 0.6f, Screen.width * WIDTH_RATIO, Screen.height * HEIGHT_RATIO);
