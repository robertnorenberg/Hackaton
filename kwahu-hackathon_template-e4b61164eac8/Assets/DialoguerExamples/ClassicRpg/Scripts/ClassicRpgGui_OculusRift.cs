...
public class ClassicRpgGui_OculusRift : MonoBehaviour {

	// od karola
	// tu masz proporcje dialog okna wg ekranu
	public const float HEIGHT_RATIO = 0.3f;
	public const float WIDTH_RATIO = 0.2f;
	...
	private void DrawGUI(float offset = 0f)
	{
		float rectX = Screen.width * (0.25f + offset);
		float rectY = Screen.height * 0.5f;
		float rectWidth = Screen.width * WIDTH_RATIO;
		float rectHeight = Screen.height * HEIGHT_RATIO;
